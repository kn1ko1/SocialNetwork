...
func addApiHandlers(rt *router.Router) {
	...
	// postUserByPostIdAndUserIdHandler := api.NewPostUserByPostIdAndUserIdHandler(r)
	...
	// rt.AddHandler(regexp.MustCompile(`^/api/[0-9]+/posts/[0-9]+$`), postUserByPostIdAndUserIdHandler)
	// // Post Handlers
