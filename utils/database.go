...
// 	identityDB, err := sql.Open("sqlite3", "./sqlite/data/Identity.db")
// 	if err != nil {
// 		HandleError("Unable to open identity database", err)
// 	}
...
// 	if err != nil {
// 		HandleError("Error applying 'up' migrations for identity.db: ", err)
// 	}
...
// 	businessDB, err := sql.Open("sqlite3", "./sqlite/data/Business.db")
// 	if err != nil {
// 		HandleError("Unable to open business database", err)
// 	}
...
// 	if err != nil {
// 		HandleError("Error applying 'up' migrations for business.db: ", err)
// 	}
...
// 	if err != nil {
// 		HandleError("Error reading migration directory", err)
// 		return
// 	}
