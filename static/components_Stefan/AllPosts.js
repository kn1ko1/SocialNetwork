...
export const AllPosts = props => {
  ...
  useEffect(() => {
    if (!loaded) {
      fetch("http://localhost:8080/view-public-posts").then(response => response.json()).then(data => {
        if (props.user && Object.keys(props.user).length !== 0 || Object.keys(usr).length !== 0) {
          const filteredPosts = data.filter(post => post.author === props.user.nickname || post.author === usr.nickname);
  ...
  useEffect(() => {
    ...
    (async () => {
      if (props.user && Object.keys(props.user).length !== 0) {
        fetch("http://localhost:8080/view-public-posts").then(response => response.json()).then(data => {
          if (props.user && Object.keys(props.user).length !== 0 || Object.keys(usr).length !== 0) {
            filtered = data.filter(post => post.author === props.user.nickname || post.author === usr.nickname);
          }
        });
        let privatePostsPromise = await fetch("http://localhost:8080/view-private-posts");
        let result = await privatePostsPromise.json();
        let filteredResult = result.filter(post => post.author === props.user.nickname);
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [loaded && posts && posts.slice().reverse().map((post, index) => /*#__PURE__*/_jsx("div", {
      className: "post",
    ...
    }, index)), !loaded && /*#__PURE__*/_jsx("div", {
      className: "post-loader-container",
...
export const GetChat = () => {
  ...
  const displayPrivateChatRooms = privateChat => {
    if (privateChat) {
      fetch("http://localhost:8080/get-chat").then(response => response.json()).then(data => {
        //sort here
  ...
  const newChatCreated = chatInfo => {
    ...
    if (chatInfo["chat-type"] === "private") {
      ...
      setChats(chatrooms => {
        ...
        return {
          ...chatrooms,
          "group-chatrooms": [...groupChats, chatInfo]
        };
      });
    }
  };
  ...
  return /*#__PURE__*/_jsxs(_Fragment, {
    children: [visible && /*#__PURE__*/_jsxs(_Fragment, {
      children: [/*#__PURE__*/_jsxs("div", {
        ...
        children: [/*#__PURE__*/_jsxs("div", {
          className: "open-chat-close-container",
          children: [/*#__PURE__*/_jsx("button", {
            ...
            children: "Chat Rooms"
          }), /*#__PURE__*/_jsx(CreateChat, {
            onSubmit: newChatCreated
          })]
        }), /*#__PURE__*/_jsxs("div", {
          ...
          className: "chatrooms",
          children: isPrivate ? /*#__PURE__*/_jsx(_Fragment, {
            children: chats["private-chatrooms"] ? /*#__PURE__*/_jsx(_Fragment, {
              children: chats["private-chatrooms"].map(chat => /*#__PURE__*/_jsx(ChatBox, {
                r: chat["chatroom-id"],
                n: "",
                u: chat["users"],
                t: isPrivate,
              ...
              children: "No Private Chats Yet?"
            })
          }) : /*#__PURE__*/_jsx(_Fragment, {
            children: chats["group-chatrooms"] ? /*#__PURE__*/_jsx(_Fragment, {
              children: chats["group-chatrooms"].map(chat => /*#__PURE__*/_jsx(ChatBox, {
                r: chat["chatroom-id"],
                n: chat["chat-name"],
                u: chat["users"],
                t: isPrivate,
