...
export const AddUserToGroupButton = groupInfo => {
  ...
  let filteredFriends = [];
  if (friends != null) {
    filteredFriends = friends.filter(checkbox => checkbox.name.toLowerCase().includes(searchInput.toLowerCase()));
  }
  ...
  return /*#__PURE__*/_jsxs("form", {
    className: "group-members-form",
    onSubmit: handleUserSubmit,
    children: [/*#__PURE__*/_jsx("div", {
      className: "comment-post-header",
      ...
      className: "create-chat-followers",
      children: filteredFriends.slice().map(friend => {
        if (friend.name != user) {
          return /*#__PURE__*/_jsxs("div", {
            children: [/*#__PURE__*/_jsx("input", {
              ...
              onChange: () => handleFriendClick(friend.name)
            }), /*#__PURE__*/_jsx("label", {
              htmlFor: friend.name,
